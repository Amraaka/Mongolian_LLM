...
python3 src/2_finetune_qa.py --peft qlora --batch_size 2 --epochs 4 --eval_batch 1 --lr 5e-5 --grad_accum_step 4 --warmup_step 150 --save_version 0.3


python3 src/2_finetune_qa.py --peft qlora --batch_size 2 --epochs 3 --eval_batch 1 --lr 3e-5 --grad_accum_step 4 --warmup_step 150 --save_version 0.3
